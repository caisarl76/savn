...
#M_SAVN 이름의 클래스로
# 위와 같은 클래스 만들기
# flag_parser.py의 parser.add_argument("--model", type=str, default="BaseModel", help="Model to use.") 에서 M_SAVN 불로오도록
# models 폴더의 basemodel savn, tcn 보고 참고

class M_SAVN(torch.nn.Module):
    def __init__(self, args):
        action_space = args.action_space
        target_embedding_sz = args.glove_dim
        resnet_embedding_sz = args.hidden_state_sz
        hidden_state_sz = args.hidden_state_sz
        super(M_SAVN, self).__init__()
